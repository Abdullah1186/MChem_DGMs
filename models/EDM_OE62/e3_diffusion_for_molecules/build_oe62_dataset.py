...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_dir", type=str, default='/users/afekaiki/EDM/e3_diffusion_for_molecules/data/oe62')
    parser.add_argument("--data_file", type=str, default="oe62.msgpack")
