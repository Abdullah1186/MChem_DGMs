...
data_file = '/users/afekaiki/EDM/e3_diffusion_for_molecules/data/oe62/geom_oe62_1.npy'
...
kwargs = {'entity': args.wandb_usr, 'name': args.exp_name, 'project': 'EDM_oe62', 'config': args,
