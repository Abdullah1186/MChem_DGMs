...
if __name__ == '__main__':
    ...
    from configs.datasets_config import qm9_with_h, oe62_with_h
    ...
    elif task_dataset == 'oe62':
        files = load_xyz_files('outputs/data')
        matplotlib.use('macosx')
        for file in files:
            x, one_hot, _ = load_molecule_xyz(file, dataset_info=oe62_with_h)
            ...
            plot_data3d(
                positions_centered, atom_type, dataset_info=oe62_with_h,
                spheres_3d=False)
